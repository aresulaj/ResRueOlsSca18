...
% Created: 6/1/10 - Shawn R Olsen
% Modified: 10/15/11 - SRO
...
try
    ...
    if handles.flag.parallelport
        ...
        bitOn = 0;        % bitOn is 0 because lines 1,14 are inverted (see PP pin out)
        bitOff = 1;
    end
    ...
    % Open gray screen
    HideCursor
    [w,wRect] = Screen('OpenWindow',screenNum,grayPixVal);
    ...
    switch stimType
        ...
        case'Black squares'
            p.xsteps=5; %10;
            p.ysteps=5;  %6
            val.location = 1:p.xsteps*p.ysteps;
            val.contrast = [0 250];%[0 250]
            val.orientation = NaN;
            
        case 'Aperture gratings'
            val.location = 1;
        otherwise
            val.location = NaN;
    end
    ...
    if any(strcmp(stimType,{'Localized gratings','Aperture gratings'}))  %%% --- Tony 'Black squares',
        ...
        if strcmp(stimType,'Aperture gratings')
            % Make aperture mask
            [maskMat,maskSizePix,maskRefRect] =makeAperture( p,d,visSizeStim,white,black);
    ...
    while(rep < nReps)
        ...
        switch stimType
            ...
            case 'Black squares'
                Screen('FillRect',w,grayPixVal);
                p.xstart = p.xLocMask;
                p.ystart = p.yLocMask;%270;
                p.xend = p.xstart+p.maskSize*p.xsteps; %540;
                p.yend =p.ystart+p.maskSize*p.ysteps; %1152; %810;
                xinc = floor((p.xend - p.xstart)/p.xsteps);
                yinc = floor((p.yend - p.ystart)/p.ysteps);
                p.squaresize = p.maskSize; %60
                
                for s = stimInd
                    
                    % Set stimulus location
                    [mi ni] = ind2sub([p.ysteps p.xsteps],stim.location(s));
                    
                    yc = p.ystart+yinc*(mi-1);
                    xc = p.xstart+xinc*(ni-1);
                    ...
                    while(vbl < vblEndTime)
                        ...
                        Screen('FillRect',w,stim.contrast(s),[xc yc xc+p.squaresize yc+p.squaresize]);
                        % Draw box in corner of screen
                        frameChangeBox(w,wRect,i)
            ...
            case 'Full-field'
                ...
                % Set pre period to black
                Screen('FillRect',w,blackPixVal);
                
                while(vbl < vblEndTime)
                    
                    i = i + 1;
                    Screen('FillRect',w,whitePixVal);
...
d.ScreenSizecmX = 52.32;          % Put in RigSpecific
d.ScreenSizecmY = 29.46;        % Put in RigSpecific
...
% Hints: contents = get(hObject,'String') returns maskType contents as cell array
%        contents{get(hObject,'Value')} returns selected item from maskType
...
% --- Executes on button press in fullFieldChk.
function fullFieldChk_Callback(hObject, eventdata, handles)
% hObject    handle to fullFieldChk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of fullFieldChk



function xLocMask_Callback(hObject, eventdata, handles)
% hObject    handle to xLocMask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xLocMask as text
%        str2double(get(hObject,'String')) returns contents of xLocMask as a double


% --- Executes during object creation, after setting all properties.
function xLocMask_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xLocMask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function yLocMask_Callback(hObject, eventdata, handles)
% hObject    handle to yLocMask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of yLocMask as text
%        str2double(get(hObject,'String')) returns contents of yLocMask as a double


% --- Executes during object creation, after setting all properties.
function yLocMask_CreateFcn(hObject, eventdata, handles)
% hObject    handle to yLocMask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function xsteps_Callback(hObject, eventdata, handles)
% hObject    handle to ysteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ysteps as text
%        str2double(get(hObject,'String')) returns contents of ysteps as a double


% --- Executes during object creation, after setting all properties.
function xsteps_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ysteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ysteps_Callback(hObject, eventdata, handles)
% hObject    handle to ysteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function ysteps_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ysteps (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
