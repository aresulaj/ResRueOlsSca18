...
RigDef = RigDefs;
set(hObject,'Units','pixels','Position',[RigDef.PlotChooser.Position 439 423])
...
function Table2Header_Callback(hObject, eventdata, handles)
% hObject    handle to Table2Header (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Table2Header as text
%        str2double(get(hObject,'String')) returns contents of Table2Header as a double


% --------------------------------------------------------------------
function DaqTable1_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to DaqTable1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on key press with focus on DaqTable1 and none of its controls.
function DaqTable1_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to DaqTable1 (see GCBO)
