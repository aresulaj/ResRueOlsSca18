...
%AR added this line
i=[1 22 28 18 25 23 29 19 27 26 31 21 20 32 24 30 2:17];
handles.ChannelInfo =handles.ChannelInfo(i,:);
...
value = strcmp(RigDef.Probe.UserProbes,expt.probe.configuration);
...
RigDef = RigDefs;
set(hObject,'Units','pixels','Position',[RigDef.PlotChooser.Position 439 423]) %356])
