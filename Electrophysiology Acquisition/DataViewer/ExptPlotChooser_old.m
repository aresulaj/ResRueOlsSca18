function varargout = ExptPlotChooser_old(varargin)
%
%
%
%   Created: 1/10 - SRO
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @ExptPlotChooser_old_OpeningFcn, ...
    'gui_OutputFcn',  @ExptPlotChooser_old_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function ExptPlotChooser_old_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = ExptPlotChooser_old_OutputFcn(hObject, eventdata, handles)
