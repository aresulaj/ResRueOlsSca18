...
%             expt.probe.channelorder = [9 8 10 7 13 4 12 5 15 2 16 1 14 3 11 6];
    ...
    case {'1x32','1 x 32', '1x32 Edge'}
        %AR added this
        %expt.probe.channelorder = [22 28 18 25 23 29 19 27 26 31 21 20 32 24 30 1:16];
        expt.probe.channelorder = 32:-1:1;
end
...
for i = 1:expt.probe.numtrodes
    ...
    channelInd = 1 + (i-1)*4;
     if i == 8
        expt.probe.trode.sites{i} = channelorder(channelInd:channelInd+(sitesPerTrode-2));
    else
